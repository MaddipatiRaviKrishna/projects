...
<tr>
<td><label>Bike name</label></td>
<td>
<input type='text'path="bike name" required="required">
</td>
</tr>
...
<td>
<input type='text'path="bike number" required="required"></input>
</td>
</tr>
...
<td>
<input type='text' path="issue" required="required">
</td>
</tr>
